...
from get_averages_and_std_per_phoneme import get_phonemes_from_single_file
...
if __name__=="__main__":
    ...
    # plotting normalized 
    # have to run get averages_and_std_per_phoneme.py first
    print("normalized")
    folder_with_mean_and_stds="../average_and_std_phoneme_feature/weighted_average_total/"
    features_rolled_out, phonemes_from = get_features_from_files(files_searching, weighted_average_phoneme_length, normalize=True, folder_with_mean_and_stds=folder_with_mean_and_stds)
    # plotting all classes
    plot_umap(features_rolled_out, phonemes_from, weighted_average_phoneme_length) 
